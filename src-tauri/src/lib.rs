...
pub fn run() {
    ...
    let builder = builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::save_provider_folders_order,
            commands::set_provider_folder_expanded,
            commands::get_folder_suggest_config,
            commands::set_folder_suggest_config,
            commands::suggest_provider_folders,
